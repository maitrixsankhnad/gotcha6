...
$(document).on("submit", "#create_incident", function (e) {
    ...
    if(!$('input:radio[name="rm_id"]').is(':checked')) {
        var notchecked = true;
        $('input:radio[name="rm_id"]:eq(0)').click();
    }
    $.ajax({
        url: base_url + 'process/create_incident',
        dataType: 'json',
        type: 'POST',
        data: new FormData(this),
        processData: false,
        ...
        success: function (data) {
            swal({
                title: 'Create Incident Successfull!',
                text: "Thank you for Create Incident on our website. - Gotcha-6.",
                type: 'success',
                confirmButtonColor: '#009688',
                confirmButtonText: 'Okey!'
            }).then(function () {
...
function resetRM (){
    ...
    $("[name=rm_id]").removeAttr("checked");
}

/*  Assign The default resource Manager to the incident  */

function selectDefaultRM () {
...
/* Assigned the incident to the SME */

$(document).on("submit", "#assigned_sme", function (e) {
    if (!validateForm('assigned_sme')) return false;
    e.preventDefault();
    swal({
        title: 'Are you sure?',
        ...
        swal({
            title: 'Accepted!!',
            text: 'You have assigned for this incident.',
            type: 'success'
        }, function() {
            form.submit();
        });
    ...
    $.ajax({
        url: base_url + 'process/assigned_sme',
        dataType: 'json',
        type: 'POST',
        data: new FormData(this),
        processData: false,
...
/* Change the status of recent activity unread to read */
...
function changeStatus(id){
    ...
    $.ajax({
        type: "POST",
        url: base_url + "process/UpdateRecentAcitivityStatus",
        data: inputData,
        dataType: "JSON",
        cache:false,
        success:
