...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'slickthemes.slickpanel.controller' => 'getSlickthemes_Slickpanel_ControllerService',
            'slickthemes.slickpanel.controller.userconfig' => 'getSlickthemes_Slickpanel_Controller_UserconfigService',
            'slickthemes.slickpanel.listener' => 'getSlickthemes_Slickpanel_ListenerService',
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'zzz_oauth_tokens', 'zzz_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'zzz_users', $this, './', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'zzz_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'zzz_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './', 'php', 'zzz_forums', 'zzz_posts', 'zzz_topics', 'zzz_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('zzz_captcha_questions', 'zzz_captcha_answers', 'zzz_qa_confirm');
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('', 'root', '', 'db_gotcha6', '', false, false);
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('slickthemes.slickpanel.listener', 'slickthemes\\slickpanel\\event\\slickpanel_listener');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), $this->get('user'), 'zzz_ext', './', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './', 'adm/', 'php', 'zzz_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'zzz_migrations', './', 'php', 'zzz_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './', 'php', 'zzz_modules');
    }
    ...
    {
        return new \phpbb\notification\type\admin_activate_user($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\bookmark($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\quote($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './', 'php', 'zzz_notification_types', 'zzz_notifications', 'zzz_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'zzz_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'zzz_profile_fields', 'zzz_profile_lang', 'zzz_profile_fields_data');
    }
    ...
    /**
     * Gets the 'slickthemes.slickpanel.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \slickthemes\slickpanel\controller\slickpanel A slickthemes\slickpanel\controller\slickpanel instance.
     */
    protected function getSlickthemes_Slickpanel_ControllerService()
    {
        return $this->services['slickthemes.slickpanel.controller'] = new \slickthemes\slickpanel\controller\slickpanel($this->get('auth'), $this->get('config'), $this->get('config_text'), $this->get('template'), $this->get('user'), $this->get('controller.helper'), './', 'php', $this->get('slickthemes.slickpanel.controller.userconfig'));
    }

    /**
     * Gets the 'slickthemes.slickpanel.controller.userconfig' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \slickthemes\slickpanel\controller\userconfig A slickthemes\slickpanel\controller\userconfig instance.
     */
    protected function getSlickthemes_Slickpanel_Controller_UserconfigService()
    {
        return $this->services['slickthemes.slickpanel.controller.userconfig'] = new \slickthemes\slickpanel\controller\userconfig($this->get('auth'), $this->get('config'), $this->get('config_text'), $this->get('request'), $this->get('user'), $this->get('controller.helper'));
    }

    /**
     * Gets the 'slickthemes.slickpanel.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \slickthemes\slickpanel\event\slickpanel_listener A slickthemes\slickpanel\event\slickpanel_listener instance.
     */
    protected function getSlickthemes_Slickpanel_ListenerService()
    {
        return $this->services['slickthemes.slickpanel.listener'] = new \slickthemes\slickpanel\event\slickpanel_listener($this->get('config'), $this->get('config_text'), $this->get('template'), $this->get('user'), $this->get('controller.helper'), $this->get('request'));
    }
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './', 'php', 'zzz_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            'core.root_path' => './',
            'core.php_ext' => 'php',
            'tables.auth_provider_oauth_token_storage' => 'zzz_oauth_tokens',
            'tables.auth_provider_oauth_account_assoc' => 'zzz_oauth_accounts',
            'tables.captcha_qa_questions' => 'zzz_captcha_questions',
            'tables.captcha_qa_answers' => 'zzz_captcha_answers',
            'tables.captcha_qa_confirm' => 'zzz_qa_confirm',
            'tables.config' => 'zzz_config',
            'tables.config_text' => 'zzz_config_text',
            'tables.ext' => 'zzz_ext',
            'tables.forums' => 'zzz_forums',
            'tables.log' => 'zzz_log',
            'tables.migrations' => 'zzz_migrations',
            'tables.modules' => 'zzz_modules',
            'tables.notification_types' => 'zzz_notification_types',
            'tables.notifications' => 'zzz_notifications',
            'tables.profile_fields' => 'zzz_profile_fields',
            'tables.profile_fields_data' => 'zzz_profile_fields_data',
            'tables.profile_fields_options_language' => 'zzz_profile_fields_lang',
            'tables.profile_fields_language' => 'zzz_profile_lang',
            'tables.posts' => 'zzz_posts',
            'tables.topics' => 'zzz_topics',
            'tables.user_notifications' => 'zzz_user_notifications',
            'tables.users' => 'zzz_users',
