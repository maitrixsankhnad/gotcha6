<?php
$headerMsg = $data['isDeclined'] ? 'Declined':'Accepted';
$bodyMsg   = $data['isDeclined'] ? 'Oops!! Your request has been declined by the resource manager for the incident <a href="'.base_url().'dashboard/incident_preview/'.encode($data['incidentid']).'" target=_blank>('.$data['incidentData'].')</a>. Please choose different resource manager for your task':'Cheers!! Your request has been approved for the incident <a href="'.base_url().'dashboard/incident_preview/'.encode($data['incidentid']).'" target=_blank>('.$data['incidentData'].')</a>. Keep track your data using the following button.'; 
$message = '
