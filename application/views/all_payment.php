								...
								<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
									...
									<tbody class="boxInputFull">
										<tr>
											...
											<td> 04 July 2017 </td>
											<td>This handy tool helps you</td>
											<td> $ 510</td>											
											<td> <span class="btn btn-info btn-xs">In Process<span></span></span></td>
											<td><div class="btn-group">
								<button  data-toggle="modal" data-target=".user-details" class="btn btn-sm btn-primary"  type="button"><i class="fa fa-eye"></i> Invoice</button>											
