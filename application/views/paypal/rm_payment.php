...
<div class="col-md-6 col-md-offset-3 ">
  ...
  <div class="formBoxRating">
      <form method="post" action="<?=base_url()?>paypal/payAdmin/<?=encode($product[0]['fld_id'])?>">
        <?php  $rmincidentData    = getAssignedRMID($product[0]['fld_id']);
      ...
      <div class="col-md-6">
          ...
          <br>
          <label>Billing Name:</label> <?=$rmData[0]['fld_fname'].' '.$rmData[0]['fld_mname'].' '.$rmData[0]['fld_lname'];?>
          <br>
          <label>Email:</label> <?=$rmData[0]['fld_paypal'];?>
