          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a href="javascript:void(0)"><i class="fa fa-laptop"></i> Ipsum <span class="label label-success pull-right">Coming Soon</span></a></li>
              </ul>
            </div>
        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <center><h3>Incident Update</h3></center>
            </div>
            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form class="form-horizontal form-label-left">
                  ...
                  <div class="form-group">
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <div class="">
                          <label>
                            <input type="checkbox" class="js-switch" checked /> Master Timer
                          </label>
                        </div>
                    ...
                    <div class="row">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Incident Number</label>
                      <div class="col-md-4 col-sm-4 col-xs-12" style="padding-bottom: 1em;">
                        <input type="text" class="form-control" placeholder="">
                      </div>
                      <div class="col-md-3">
                        <button class="btn btn-default">Ticket</button>
                      </div>
                    </div>
                    ...
                    <div class="row" style="padding-bottom: 0.2em;">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Resource Manager</label>
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="text" class="form-control" placeholder="">
                      </div>
                    </div>
                  ...
                  <div class="row" style="padding-bottom: 1em">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">SME</label>
                  ...
                  <div class="row">
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Updates/Notes <span class="required"></span>
                      </label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                  ...
                  <div class="row">
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12">Auto Complete</label>
											<div class="col-md-9 col-sm-9 col-xs-12">
                  ...
                  <p align="right"><button class="btn btn-primary">Submit</button></p>
                </form>
              </div>
            </div>
          </div>
